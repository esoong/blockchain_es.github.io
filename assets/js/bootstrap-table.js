...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn btn-STCStyle-opposit" type="button" name="paginationSwitch" title="%s">',
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button class="btn btn-STCStyle-opposit' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
        ...
        if (this.options.showToggle) {
            html.push(sprintf('<button class="btn btn-STCStyle-opposit' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="toggle" title="%s">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" class="btn btn-STCStyle-opposit' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        var pageNumber = [
                sprintf('<span class="btn-group %s">',
                    this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                    'dropdown' : 'dropup'),
                '<button type="button" class="btn btn-STCStyle-opposit ' +
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        // show no records
        if (!html.length) {
            html.push('<tr id="noData" class="no-records-found">',
